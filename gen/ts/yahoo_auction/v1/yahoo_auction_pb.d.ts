 ...
 *
 * @generated from message yahoo_auction.v1.SearchAuctionsRequest
 */
export declare type SearchAuctionsRequest = Message<"yahoo_auction.v1.SearchAuctionsRequest"> & {
  /**
   * query は検索キーワードです。
   *
 ...
 */
export declare const SearchAuctionsRequestSchema: GenMessage<SearchAuctionsRequest>;

/**
 * SearchAuctionsResponse はヤフオクの検索結果を返すレスポンスです。
 *
 * @generated from message yahoo_auction.v1.SearchAuctionsResponse
 */
export declare type SearchAuctionsResponse = Message<"yahoo_auction.v1.SearchAuctionsResponse"> & {
  /**
   * items は商品のリストです（新着順）。
   *
   * @generated from field: repeated yahoo_auction.v1.SearchAuctionsResponse.Item items = 1;
   */
  items: SearchAuctionsResponse_Item[];
 ...
 */
export declare const SearchAuctionsResponseSchema: GenMessage<SearchAuctionsResponse>;

/**
 * @generated from message yahoo_auction.v1.SearchAuctionsResponse.Item
 */
export declare type SearchAuctionsResponse_Item = Message<"yahoo_auction.v1.SearchAuctionsResponse.Item"> & {
  /**
   * auction_id はヤフオクのオークションIDです。
   *
   * @generated from field: string auction_id = 1;
 ...
 */
export declare const SearchAuctionsResponse_ItemSchema: GenMessage<SearchAuctionsResponse_Item>;
...
export declare const YahooAuctionService: GenService<{
  ...
  searchAuctions: {
    methodKind: "unary";
    input: typeof SearchAuctionsRequestSchema;
    output: typeof SearchAuctionsResponseSchema;
  },
}>;
